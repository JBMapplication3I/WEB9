...
(function (angular) {
        ...
        return {
            ...
            controller: ['$scope', function ($scope) {
                ...
                $scope.update = function () {
                    ...
                    $scope.hueSlider.left = ($scope.hsva.h) * $scope.hueMax.x + 'px';
            ...
            link: function (scope, element, attr) {
                ...
                template = angular.element('<div ng-show="show" class="color-picker {{extraLargeClass}}" style="touch-action: none;">' +
                    '   <div class="arrow arrow-' + attr.colorPickerPosition + '"></div>' +
                    '   <div colorpickerslider rg-x=1 rg-y=1 action="setSaturationAndBrightness(s, v, rgX, rgY)" class="saturation-lightness" ng-style="{\'background-color\':hueSliderColor}">' +
                    '       <div class="cursor-sv" ng-style="{\'top\':sAndLSlider.top, \'left\':sAndLSlider.left}"></div>' +
                    '   </div>' +
                    '   <div colorpickerslider rg-x=1 action="setHue(v, rg)" class="hue">' +
                    '       <div class="cursor" ng-style="{\'left\':hueSlider.left}"></div>' +
                    '   </div>' +
                    '   <div class="hex-text alpha" ng-show="type==0">' +
                ...
                function setDialogPosition() {
                    ...
                    switch (attr.colorPickerPosition) {
                        case 'left': {
    ...
    colorPicker.directive('colorpickerslider', ['$document', '$window', function ($document, $window) {
        return {
            restrict: 'A',
            scope: {
                action: '&'
