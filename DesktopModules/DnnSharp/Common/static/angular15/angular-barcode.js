/**
 * dnnsfAngular15 barcode
 * @version v0.0.4 - 2016-02-11 * @link https://github.com/ryanmc2033/dnnsfAngular15-barcode
 * @author Ryan McLaughlin <ryanmc@justechn.com>
 * @license MIT License, http://www.opensource.org/licenses/MIT
 */
 dnnsfAngular15.module('barcode', []).directive('barcode', [
    'BarcodeService',
    'Code39Service',
    'Code128BService',
    'Code128CService',
    ...
    function (barcodeService,
        ...
        function link(scope, element, attrs) {
            ...
            options = barcodeService.merge(defaults, {
                width: scope.width,
                height: scope.height,
            ...
            if (!dnnsfAngular15.isUndefined(binary)) {
                ...
                if (attrs.render == "img") {
                    ...
                    $('#' + attrs.formField).attr('data-val', uri.split(',')[1])
                    .next('img').attr("src", uri);
                }
            }
        }

        function watchStringAttr(scope, element, attrs) {
            scope.displayValue = attrs.displayvalue;
            if (scope.displayValue == 'True')
                scope.displayValue = true;
            else scope.displayValue = false;
            scope.textAlign = attrs.textalign;
...
dnnsfAngular15.module("barcode").factory('BarcodeService', [
    function () {
        'use strict';
...
dnnsfAngular15.module("barcode").factory('Code128Service', [function () {
    'use strict';
...
dnnsfAngular15.module("barcode").factory('Code128BService', ['Code128Service', function (Code128Service) {
    'use strict';
...
dnnsfAngular15.module("barcode").factory('Code128CService', [
    'Code128Service',
...
dnnsfAngular15.module("barcode").factory('Code39Service', [function () {
    'use strict';
...
dnnsfAngular15.module("barcode").factory('EanService', [function () {
    'use strict';
...
dnnsfAngular15.module("barcode").factory('Itf14NumberService', [function () {
    'use strict';
...
dnnsfAngular15.module("barcode").factory('ItfNumberService', [function () {
    'use strict';
...
dnnsfAngular15.module("barcode").factory('UpcService', [function () {
    'use strict';
