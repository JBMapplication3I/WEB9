    ...
    $.extend($.fn, {
        ...
        valid: function () {
            ...
            if ($(this[0]).is("form")) {
                ...
                var valid = true;
                var container = $(this).parents('.form-root').length ? $(this).parents('.form-root:first') : $(this[0].form);
        ...
        rules: function (command, argument) {
            ...
            if (command) {
                var container = $(element).parents('.form-root').length ? $(element).parents('.form-root:first') : $(element.form);
    ...
    $.extend($.validator, {
        ...
        defaults: {
            ...
            onkeyup: function (element, event) {
                if (event.which === 9 && this.elementValue(element) === "") {
                    return;
                } else if (element.name in this.submitted || element === this.lastElement || !this.optional(element)) {
                    this.element(element);
                }
            },
        ...
        prototype: {
            ...
            element: function (element) {
                // copied from https://github.com/jquery-validation/jquery-validation/pull/721 that was integrated in 1.14.0
