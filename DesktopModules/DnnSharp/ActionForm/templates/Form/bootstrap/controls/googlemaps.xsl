...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="ctl-googlemaps">
        <xsl:param name="type" />
        ...
        <div>
            ...
            <div load-on-demand="'ngGooglemaps'">
                <ng-googlemaps update-field="updateField(field, val)" data-register-control="registerControl(control)">
