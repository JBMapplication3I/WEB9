...
<asp:Panel ID="pnlAdmin" runat="server">
	...
	<%--		$('#<%= rblCropMethod.ClientID %> input').change(function () {
				if ($(this).val() == 0) {
					$('#<%= rowCropResizeMode.ClientID %>').show();
				}
				else {
					$('#<%= rowCropResizeMode.ClientID %>').hide();
				}
			});
			$('#<%=rblCropMethod.ClientID %> input' ).trigger("change");--%>
						...
						<asp:Panel ID="pnlRotatorBase" runat="server">
							...
							<div class="content noTopPadding">
								<eds:EdsRadioButtonList ID="rblSelectViewType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblSelectViewType_SelectedIndexChanged" CssClass="styledRadio displayType" RepeatLayout="Flow" RepeatColumns="25" RepeatDirection="Vertical">
									<asp:ListItem Value="mostPopular" Enabled="false" Cssclass="displaySettingsTitle normalRadioButton" resourcekey="MostPopularDisplays">Most Popular Displays</asp:ListItem>
									...
									<asp:ListItem Value="19" CssClass="displayTypeThumbnail fourInRow sliderWithAnimatedLayers normalRadioButton"><span class="presetName">Slider With Animated Layers Rotator</span><span>(HTML, Images and Video (Youtube, Vimeo))</span><span class="aditional">responsive</span></asp:ListItem>
									<asp:ListItem Value="20" CssClass="displayTypeThumbnail fourInRow videoBackgroundRotator normalRadioButton"><span class="presetName">Video Background Rotator</span><span>(HTML, Images and Video (mp4, ogg, webm))</span><span class="aditional">responsive</span></asp:ListItem>
									<asp:ListItem Value="21" CssClass="displayTypeThumbnail fourInRow swiperRotator normalRadioButton"><span class="presetName">Carousel Rotator</span><span>(Images)</span><span class="aditional">responsive</span></asp:ListItem>
									<asp:ListItem Value="other" Enabled="false" CssClass="displaySettingsTitle normalRadioButton" resourcekey="OtherDisplays">Other Displays</asp:ListItem>
											...
											<div class="edn_admin_progress_overlay_container">
												...
												<div class="optionsPanel paddingTopBottom">
													...
													<table>
														...
														<tr>
															...
															<td>
																<table class="clearWidth textLeft nowrap">
																	<tr>
																		<td>
																			<asp:RadioButtonList ID="rblLimitBackEvents" runat="server" RepeatDirection="Horizontal" CssClass="styledRadio small" AutoPostBack="true" OnSelectedIndexChanged="rblLimitBackEvents_SelectedIndexChanged">
																				<asp:ListItem Value="All" resourcekey="liShowAll" Text="ShowAll" />
																				<asp:ListItem Value="ShowOnlyPastEvents" resourcekey="liShowOnlyPastEvents" Text="Show only past events" />
																				<asp:ListItem Value="Limit" resourcekey="liLimitDays" Text="Limit to number of days in the past:" Selected="True" />
																			</asp:RadioButtonList>
																		</td>
																		<td></td>
																		<td>
														...
														<tr>
															<td class="labels">
																<dnn:Label ID="lblRestrictionByDateRange" runat="server" HelpKey="lblRestrictionByDateRange.HelpText" HelpText="Here you can enter a number of days in the past from which articles will be displayed." ResourceKey="lblRestrictionByDateRange" Text="Restriction by date range:" />
															</td>
															<td>
																<div class="clearWidth textLeft nowrap">
																	<asp:RadioButtonList ID="rblRestrictionByDateRange" runat="server" CssClass="styledRadio small" RepeatDirection="Horizontal">
																		<asp:ListItem class="normalRadioButton" resourcekey="liNoRestriction" Selected="True" Text="No restriction" Value="0" />
																		<asp:ListItem class="normalRadioButton" resourcekey="liNumberOfDaysFromCurrentDate" Text="Number of days from current date" Value="1" />
																	</asp:RadioButtonList>
																</div>
										...
										<div class="edn_admin_progress_overlay_container negativeMargins40">
											...
											<asp:Panel runat="server" ID="pnlRotatorSettings" Visible="false">
															...
															<tr class="color6HighLighted">
																<td colspan="2" style="padding: 10px 40px;">
																	...
																	<div class="styledSelect large" style="vertical-align: top;">
																		...
																		<dnn:Label ID="lblRotatorLoadSettings" runat="server" HelpText="Settings from other Module instance(DB), and XML files(ControlPath/PreSettings/)." Text="" ControlName="ddlRotatorLoadSettings" HelpKey="lblRotatorLoadSettings.HelpText" />
																	</div>
																	<div class="itemActions itemEditActions">
												...
												<asp:Panel ID="pnlRotatorParametersContainer" runat="server" Visible="false" CssClass="settingsList">
													<div class="settingsTable">
														<table>
															...
															<tr runat="server" id="rowCropMethode">
																...
																<td>
																	<asp:RadioButtonList ID="rblCropMethod" runat="server" RepeatDirection="Horizontal" CssClass="styledRadio small" AutoPostBack="True" OnSelectedIndexChanged="rblCropMethod_SelectedIndexChanged">
															...
															<tr runat="server" id="rowCropResizeMode">
																<td>
																	<dnn:Label ID="lblCropResizeMode" runat="server" ControlName="rblCropResizeMode" HelpText="Choose a central point for cropping images." Text="Crop resize mode:" ResourceKey="lblCropResizeMode" />
																</td>
																<td>
																	<asp:RadioButtonList ID="rblCropResizeMode" runat="server"  RepeatDirection="Horizontal" CssClass="styledRadio small">
																		<asp:ListItem class="normalRadioButton" Value="0" resourcekey="liCenter" Selected="True">Center</asp:ListItem>
																		<asp:ListItem class="normalRadioButton" Value="1" resourcekey="liLeft">Left</asp:ListItem>
																		<asp:ListItem class="normalRadioButton" Value="2" resourcekey="liTopCenter">Top Center</asp:ListItem>
																	</asp:RadioButtonList>
																</td>
															</tr>
															<tr>
															...
															<tr runat="server" id="trEnableWebpImages">
																<td>
																	<dnn:Label ID="lblEnableWebpImages" runat="server" ControlName="cbEnableWebpImages" HelpText="Enable webp images." Text="Enable webp images:" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbEnableWebpImages" runat="server" Text="Enable webp images" />
																	</div>
																</td>
															</tr>
															<tr runat="server" id="trWebpImageQuality">
																<td>
																	<dnn:Label ID="lblWebpImageQuality" runat="server" ControlName="tbxWebpImageQuality" HelpText="Webp image compression quality. (1 - 100)" Text="Webp image compression quality:" ResourceKey="lblWebpImageQuality" HelpKey="lblWebpImageQuality.HelpText" />
																</td>
																<td>
																	<asp:TextBox ID="tbxWebpImageQuality" runat="server" MaxLength="3" ValidationGroup="SettingsSave" CssClass="small textCenter">95</asp:TextBox>
																	<asp:RequiredFieldValidator ID="rfvtbxWebpImageQuality" resourcekey="rfvtbxWebpImageQuality.ErrorMessage" runat="server" ControlToValidate="tbxWebpImageQuality" Display="Dynamic" ErrorMessage="Enter Value! " SetFocusOnError="true" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbxWebpImageQuality" resourcekey="rvtbxWebpImageQuality.ErrorMessage" runat="server" ControlToValidate="tbxWebpImageQuality" Display="Dynamic" ErrorMessage="Range between 1 and 100" MaximumValue="100" MinimumValue="1" SetFocusOnError="true"
																		Type="Integer" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
													...
													<asp:Panel ID="pnlChameleonRotator" runat="server" Visible="false" CssClass="settingsTable paddingTop">
														...
														<div class="slidingDiv paddingTopBottom" style="text-align: center;">
															<img src="<%=ControlPath%>Images/chameleonPrew.jpg" alt="Rotator Preview" usemap="#Map" style="border: 0;" />
															<map name="Map" id="Map">
																			...
																			<div class="collapsableContent" runat="server" id="pnlMPEffStripes">
																				...
																				<p class="option">
																					...
																					<p class="option">
																						...
																						<div class="styledCheckbox displayInline">
																							<asp:CheckBox ID="cbMPEffStripesRandDirect" runat="server" Checked="true" resourcekey="liRandomize" Text="Randomize" />
																						</div>
																						<p>
																						</p>
																						<p class="option">
																							...
																							<div class="styledCheckbox displayInline">
																								<asp:CheckBox ID="cbMPEffStripesRandStartAt" runat="server" Checked="true" resourcekey="liRandomize" Text="Randomize" />
																							</div>
																							<p>
																							</p>
																							<p>
													...
													<asp:Panel ID="pnlAdvancedRSettings" runat="server" Visible="false" class="settingsTable">
														...
														<div class="slidingDiv" style="text-align: center;">
															<img src="<%=ControlPath%>Images/advancedPrew.jpg" alt="Rotator Preview" usemap="#Map1" style="border: 0;" />
													...
													<asp:Panel ID="pnlMultiROprions" runat="server" Visible="false" class="settingsTable">
														...
														<table class="settings_table" runat="server" visible="false" id="rowMultiRVideoParameters">
															<tr>
																<td>
																	<dnn:Label ID="lblMultiRVideoMute" runat="server" ControlName="cbMultiRVideoMute" HelpText="Whether the video is muted." Text="Mute:" ResourceKey="lblMultiRVideoMute" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbMultiRVideoMute" runat="server" Checked="true" Text=" " />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblMultiRVideoLoop" runat="server" ControlName="cbMultiRVideoLoop" HelpText="Whether the video is looped." Text="Loop:" ResourceKey="lblMultiRVideoLoop" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbMultiRVideoLoop" runat="server" Checked="true" Text=" " />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblMultiRVideoAutopause" runat="server" ControlName="cbMultiRVideoAutopause" HelpText="Whether the slider pauses the video before changing slide then resumes it or always starts from the beginning." Text="Autopause:" ResourceKey="lblMultiRVideoAutopause" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbMultiRVideoAutopause" runat="server" Checked="false" Text=" " />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblMultiRVideoFillMode" runat="server" ControlName="ddlMultiRVideoFillMode" HelpText="Specifies the video scaling method." Text="Fill mode:" ResourceKey="lblMultiRVideoFillMode" />
																</td>
																<td>
																	<div class="styledSelect">
																		<asp:DropDownList ID="ddlMultiRVideoFillMode" runat="server">
																			<asp:ListItem Value="fill" Text="fill" Selected="True" />
																			<asp:ListItem Value="fit" Text="fit" />
																		</asp:DropDownList>
																	</div>
																</td>
															</tr>
													...
													<asp:Panel ID="pnlCarouselSwiperRotatorSettings" runat="server" Visible="false" class="settingsTable">
														<table class="settings_table">
															<tr class="color2HighLighted">
																<td colspan="2" class="textCenter">
																	<asp:Label ID="lblCsrOptions" resourcekey="lblCsrOptions" runat="server" EnableViewState="False" Text="Rotator options:" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrWidthHeight" runat="server" HelpText="The width/height of the rotator in pixelst." Text="Rotator width/height:" ResourceKey="lblCsrWidthHeight" />
																</td>
																<td>
																	<asp:TextBox ID="tbxCarouselSwiperRotatorWidth" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave">512</asp:TextBox>
																	/
																	<asp:TextBox ID="tbxCarouselSwiperRotatorHeight" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave">288</asp:TextBox>
																	<asp:RequiredFieldValidator ID="rfvCarouselSwiperRotatorWidtht" resourcekey="Valuerequired.ErrorMessage" runat="server" ControlToValidate="tbxCarouselSwiperRotatorWidth" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvCarouselSwiperRotatorWidth" resourcekey="rvSizeShifterWidth.ErrorMessage" runat="server" ControlToValidate="tbxCarouselSwiperRotatorWidth" Display="Dynamic" ErrorMessage=" (W) between 1 and 7680" MaximumValue="7680" MinimumValue="1" Type="Integer"
																		SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RequiredFieldValidator ID="rfvCarouselSwiperRotatorHeight" resourcekey="Valuerequired.ErrorMessage" runat="server" ControlToValidate="tbxCarouselSwiperRotatorHeight" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvCarouselSwiperRotatorHeight" resourcekey="rvSizeShifterHeight.ErrorMessage" runat="server" ControlToValidate="tbxCarouselSwiperRotatorHeight" Display="Dynamic" ErrorMessage=" (W) between 1 and 7680" MaximumValue="7680" MinimumValue="1" Type="Integer"
																		SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrDisplayTitle" runat="server" HelpText="Show title." Text="Show title:" ControlName="cbCsrDisplayTitle" ResourceKey="lblCsrDisplayTitle" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbCsrDisplayTitle" runat="server" Checked="true" Text="Show title" />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrItemTitleLimit" runat="server" HelpText="Title Length. Enter 0 for unlimited" Text="Title Length:" ResourceKey="lblCsrItemTitleLimit" />
																</td>
																<td>
																	<asp:TextBox ID="tbxCsrItemTitleLimit" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="0" />
																	<asp:RequiredFieldValidator ID="rfvtbxCsrItemTitleLimit" runat="server" ControlToValidate="tbxCsrItemTitleLimit" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbxCsrItemTitleLimit" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbxCsrItemTitleLimit" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave"
																		CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrDisplayDescription" runat="server" HelpText="Show description." Text="Show description:" ControlName="cbCsrDisplayDescription" ResourceKey="lblCsrDisplayDescription" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbCsrDisplayDescription" runat="server" Checked="true" Text="Show description" />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrItemDescriptionLimit" runat="server" HelpText="Description Length. Enter 0 for unlimited" Text="Description length:" ResourceKey="lblCsrItemDescriptionLimit" />
																</td>
																<td>
																	<asp:TextBox ID="tbxCsrItemDescriptionLimit" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="0" />
																	<asp:RequiredFieldValidator ID="rfvtbCsrItemDescriptionLimit" runat="server" ControlToValidate="tbxCsrItemDescriptionLimit" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbCsrItemDescriptionLimit" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbxCsrItemDescriptionLimit" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave"
																		CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrSlidesPerView" runat="server" HelpText="Number of slides per view. Select auto or set number." Text="Slides per view:" ResourceKey="lblCsrSlidesPerView" />
																</td>
																<td>
																	<asp:RadioButtonList ID="rblCsrSlidesPerView" runat="server" RepeatDirection="Horizontal" CssClass="styledRadio small">
																		<asp:ListItem resourcekey="liAuto" Selected="True" Value="0" Text="Auto" />
																		<asp:ListItem resourcekey="liSetNumber" Value="1" Text="Set number" />
																	</asp:RadioButtonList>
																	<asp:TextBox ID="tbxCsrSlidesPerView" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="2" />
																	<asp:RequiredFieldValidator ID="frvtvxCsrSlidesPerView" runat="server" ControlToValidate="tbxCsrSlidesPerView" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtvxCsrSlidesPerView" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbxCsrSlidesPerView" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrAutoplay" runat="server" HelpText="Enable autoplay." Text="Autoplay:" ControlName="cbCsrAutoplay" ResourceKey="lblCsrAutoplay" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbCsrAutoplay" runat="server" Checked="true" Text="Autoplay" />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrAutoplayDelay" runat="server" HelpText="Autoplay delay between transitions." Text="Autoplay delay:" ResourceKey="lblCsrAutoplayDelay" />
																</td>
																<td>
																	<asp:TextBox ID="tbxCsrAutoplayDelay" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="5000" />
																	<asp:RequiredFieldValidator ID="rfvtbxCsrAutoplayDelay" runat="server" ControlToValidate="tbxCsrAutoplayDelay" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbxCsrAutoplayDelay" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbxCsrAutoplayDelay" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrTransitionSpeed" runat="server" HelpText="Slide transition duration." Text="Slide transition duration:" ResourceKey="lblCsrTransitionSpeed" />
																</td>
																<td>
																	<asp:TextBox ID="tbCsrTransitionSpeed" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="300" />
																	<asp:RequiredFieldValidator ID="rfvtbCsrTransitionSpeed" runat="server" ControlToValidate="tbCsrTransitionSpeed" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbCsrTransitionSpeed" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbCsrTransitionSpeed" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblScrSpaceBetweenSlides" runat="server" HelpText="Space between slides." Text="Space between slides:" ResourceKey="lblScrSpaceBetweenSlides" />
																</td>
																<td>
																	<asp:TextBox ID="tbxScrSpaceBetweenSlides" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="10" />
																	<asp:RequiredFieldValidator ID="rfvtbxScrSpaceBetweenSlides" runat="server" ControlToValidate="tbxScrSpaceBetweenSlides" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbxScrSpaceBetweenSlides" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbxScrSpaceBetweenSlides" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblScrSlidesPerColumn" runat="server" HelpText="Number of rows." Text="Slides per column:" ResourceKey="lblScrSlidesPerColumn" />
																</td>
																<td>
																	<asp:TextBox ID="tbxScrSlidesPerColumn" runat="server" CssClass="small textCenter" MaxLength="4" ValidationGroup="SettingsSave" Text="1" />
																	<asp:RequiredFieldValidator ID="rfvtbxSlidesPerColumn" runat="server" ControlToValidate="tbxScrSlidesPerColumn" Display="Dynamic" ErrorMessage="Value! " SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																	<asp:RangeValidator ID="rvtbxSlidesPerColumn" resourcekey="rvMultiRTitleLength.ErrorMessage" runat="server" ControlToValidate="tbxScrSlidesPerColumn" Display="Dynamic" ErrorMessage="Between 0 and 9999" MaximumValue="9999" MinimumValue="0" Type="Integer" SetFocusOnError="True" ValidationGroup="SettingsSave" CssClass="smallInfo error" />
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrIsPaginationEnabled" runat="server" HelpText="Is pagination enabled." Text="Is pagination enabled:" ControlName="cbCsrIsPaginationEnabled" ResourceKey="lblCsrIsPaginationEnabled" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbCsrIsPaginationEnabled" runat="server" Checked="true" Text="IsPaginationEnabled" />
																	</div>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrPaginationType" runat="server" HelpText="Pagination type." Text="Pagination type:" ControlName="cbScrPaginationType" ResourceKey="lblCsrPaginationType" />
																</td>
																<td>
																	<asp:RadioButtonList ID="rblPaginationType" runat="server" RepeatDirection="Horizontal" CssClass="styledRadio small">
																		<asp:ListItem resourcekey="liBullets" Value="0">Bullets</asp:ListItem>
																		<asp:ListItem resourcekey="liDynamicBullets" Value="1" Selected="True">Dynamic bullets</asp:ListItem>
																		<asp:ListItem resourcekey="liFraction" Value="2">Fraction</asp:ListItem>
																		<asp:ListItem resourcekey="liProgressbar" Value="3">Progressbar</asp:ListItem>
																	</asp:RadioButtonList>
																</td>
															</tr>
															<tr>
																<td>
																	<dnn:Label ID="lblCsrIsNavigationEnabled" runat="server" HelpText="Enable navigation." Text="Enable navigation:" ControlName="cbCsrIsNavigationEnabled" ResourceKey="lblCsrIsNavigationEnabled" />
																</td>
																<td>
																	<div class="styledCheckbox noLabel">
																		<asp:CheckBox ID="cbCsrIsNavigationEnabled" runat="server" Checked="true" Text="IsPaginationEnabled" />
																	</div>
																</td>
															</tr>
														</table>
													...
													<asp:Panel ID="pnlBottomButtons" runat="server">
														...
														<div class="saveLoader">
															...
															<img id="saveLoaderGif" src="<%=ControlPath%>Images/saveloader.gif" alt="AnimaedGif" style="display: none;" />
														</div>
													</asp:Panel>
												</asp:Panel>
												<asp:Panel ID="pnlExportXMLFuter" runat="server" Visible="false" class="contentSection exportSettings">
													<div class="specialOptions">
														<h2>
															<dnn:Label ID="lblExport" ResourceKey="lblExport" runat="server" HelpText="Settings are added to DropDownList from where you can load those settings. Setting are Saved to path - ControlPath/PreSettings/" Text="Save settings:" />
															<div class="optionsList paddingTopBottom">
																<div class="styledCheckbox big noLabel">
																	<asp:CheckBox ID="cbExportSettings" runat="server" AutoPostBack="True" Checked="false" OnCheckedChanged="cbExportSettings_CheckedChanged" resourcekey="cbExportSettings" Text="Save settings" ToolTip="Enable/Disable Export" />
																</div>
															</div>
															<h2></h2>
															<h2></h2>
													...
													<asp:Panel ID="pnlExportSettings" runat="server" Visible="false" CssClass="saveLoadSettings">
														<table>
															<tr>
																<td>
																	<dnn:Label ID="lblExportSettingsName" runat="server" HelpText="Name of XML file. Location of file - ControlPath/PreSettings/. Try not too use existing file name or it will be overwriten!" Text="XML filename:" ControlName="tbxExportSettingsName" ResourceKey="lblExportSettingsName" />
																</td>
																<td>
