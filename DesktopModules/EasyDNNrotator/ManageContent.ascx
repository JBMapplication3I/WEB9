						...
						<asp:GridView ID="gvRotatorCategory" runat="server" DataSourceID="odsCategory" AutoGenerateColumns="False" DataKeyNames="CategoryID" Border="0" GridLines="None" CssClass="listItemsTable" ShowFooter="True" AllowPaging="True" AllowSorting="True" EnableModelValidation="True" OnRowCommand="gvRotatorCategory_RowCommand" OnSelectedIndexChanged="gvRotatorCategory_SelectedIndexChanged" OnRowDataBound="gvRotatorCategory_RowDataBound" OnRowDeleted="gvRotatorCategory_RowDeleted" OnDataBound="gvRotatorCategory_DataBound" OnRowUpdating="gvRotatorCategory_RowUpdating" OnRowUpdated="gvRotatorCategory_RowUpdated" OnPreRender="gvRotatorCategory_PreRender">
							<Columns>
								<asp:TemplateField ShowHeader="False" HeaderText="Actions">
									<ItemTemplate>
										<div class="itemActions itemPrimaryActions">
											...
											<asp:LinkButton ID="lblCategoryDel" runat="server" CausesValidation="False" CommandName="Delete" CssClass="deleteAction" Text="Delete" resourcekey="lbDelete.Text" OnClientClick="return AlertConfirm('category');" />
										</div>
								...
								<asp:TemplateField HeaderText="Created" InsertVisible="false" SortExpression="DateCreated">
									<ItemTemplate>
										<asp:Label ID="Label1" runat="server" Text='<%# Convert.ToDateTime(Eval("DateCreated")).ToShortDateString() %>' />
									</ItemTemplate>
								...
								<asp:TemplateField ShowHeader="False" HeaderText="Actions">
									<ItemTemplate>
										<div class="itemActions itemPrimaryActions">
											...
											<asp:LinkButton ID="lbListItemDel" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" CssClass="deleteAction" OnClientClick="return AlertConfirm('list');" resourcekey="lbDelete.Text" /><br />
										</div>
										<div class="itemActions itemSecondaryActions">
								...
								<asp:TemplateField ShowHeader="False" HeaderText="Actions">
									<ItemTemplate>
										<div class="itemActions itemPrimaryActions">
											...
											<asp:LinkButton ID="lbDeleteRotatorInline" runat="server" CausesValidation="False" CommandName="Delete" CssClass="deleteAction" Text="Delete" resourcekey="lbDelete.Text" OnClientClick="return AlertConfirm('item');" />
										</div>
										<div class="itemActions itemSecondaryActions">
							...
							<div class="optionsPanel">
								...
								<asp:Panel ID="pnlImageUploadUploadify" runat="server">
									...
									<div class="saveLoader">
										...
										<img id="saveLoaderGif" src="<%=ControlPath%>Images/saveloader.gif" alt="AnimaedGif" class="centerLoad" style="display: none; margin-left: auto; margin-right: auto; padding-bottom: 15px;" />
									</div>
								</asp:Panel>
									...
									<tr>
										...
										<td>
											...
											<asp:Panel runat="server" ID="pnlVideoStandardThumb" Visible="false" CssClass="paddingTop">
												<dnn:Label ID="lblVideoStandardThumb" runat="server" Text="Select predefined thumbnail:" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/Video." ResourceKey="lblVideoStandardThumbSelect.Text" HelpKey="lblVideoStandardThumbSelect.HelpKey" ControlName="ddlVideoThumbSelect" />
												<div class="styledSelect">
									...
									<tr>
										...
										<td>
											...
											<asp:Panel runat="server" ID="pnlAmazonVideoStandardThumb" Visible="false" CssClass="paddingTop">
												<dnn:Label ID="lblAmazonVideoStandardThumb" runat="server" Text="Select predefined thumbnail:" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/Video." ControlName="ddlAmazonVideoThumbSelect" ResourceKey="lblVideoStandardThumbSelect.Text." />
												<div class="styledSelect">
									...
									<tr>
										...
										<td>
											...
											<asp:Panel runat="server" ID="pnlHTMLStandardThumb" Visible="false" CssClass="paddingTop">
												<dnn:Label ID="lblHTMLStandardThumb" runat="server" Text="Select standard thumbnail:" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/HTML/." ResourceKey="lblHTMLStandardThumbSelect.Text" HelpKey="lblHTMLStandardThumbSelect.HelpKey" ControlName="ddlHTMLThumbSelect" />
												<div class="styledSelect">
				...
				<asp:Panel ID="pnlEditContent" runat="server" Visible="false">
							...
							<tr>
								...
								<td>
									...
									<asp:Panel ID="pnlAmazonEditVideoThumbSelect" runat="server" Visible="false" CssClass="paddingTop">
										<dnn:Label ID="lblAmazonEditVideoThumbSelect" runat="server" ControlName="ddlAmazonEditVideoThumbSelect" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/Video." Text="Select standard thumbnail:" />
										<div class="styledSelect">
					...
					<asp:Panel ID="pnlEditVideo" runat="server" Visible="false" CssClass="listItems additionalOptions videoEdit">
						...
						<table class="additionalOptionsList fullWidthTable noTdBorders noTableBorder">
							...
							<tr>
								...
								<td>
									...
									<asp:Panel ID="pnlEditVideoThumbSelect" runat="server" Visible="false" CssClass="paddingTop">
										<dnn:Label ID="lblEditVideoThumbSelect" runat="server" ControlName="ddlEditVideoThumbSelect" HelpKey="lblVideoStandardThumbSelect.HelpKey" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/Video." ResourceKey="lblVideoStandardThumbSelect.Text" Text="Select standard thumbnail:" />
										<div class="styledSelect">
							...
							<tr>
								...
								<td>
									<asp:RadioButtonList ID="rblEditVideoUpdate" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblEditVideoUpdate_SelectedIndexChanged" CssClass="styledRadio small">
										<asp:ListItem Selected="True" Text="Don't update video" Value="NoUpdateVideo" />
							...
							<tr>
								<td class="subjectName short">
									<dnn:Label ID="lblAddAdditionalVideos" runat="server" Text="Add additional videos:" HelpText="Add additional videos." ResourceKey="lblAddAdditionalVideos.Text" HelpKey="lblAddAdditionalVideos.Help" />
								</td>
								<td>
									<div class="itemActions itemEditActions big">
										<asp:LinkButton ID="lbAddAdditionalVideos" runat="server" Text="Add Additional Videos" resourcekey="lbAddAdditionalVideos.Text" CausesValidation="True" OnClick="lbAddAdditionalVideos_Click" CssClass="itemEditAdd" />
									</div>
								</td>
							</tr>
							<tr runat="server" id="trAddAdditionalVideosUpload" visible="false">
								<td class="subjectName short"></td>
								<td>
									<asp:Panel ID="Panel1" runat="server" Visible="true" CssClass="paddingTop paddingBottom">
										<dnn:Label ID="Label2" runat="server" ControlName="fuAddAdditionalVideos" HelpKey="lblAddVideoUpload.HelpKey" HelpText="Select video for upload (mp4, flv, swf, webm, ogg)." ResourceKey="lblAddVideoUpload.Text" Text="Video:" />
										<asp:FileUpload ID="fuAddAdditionalVideos" runat="server" Width="400px" />
										<div class="itemActions itemEditActions">
											<asp:LinkButton ID="lbUploadAddAdditionalVideo" runat="server" Text="Upload" resourcekey="lbUploadAddAdditionalVideo.Text" CausesValidation="True" OnClick="lbUploadAddAdditionalVideo_Click" CssClass="itemEditAdd" />
										</div>
									</asp:Panel>
								</td>
							</tr>
							<tr>
								<td class="subjectName textTop short">
									<dnn:Label ID="Label5" runat="server" Text="Additional videos:" HelpText="Additional videos." ResourceKey="lblAddAdditionalVideos.Text" HelpKey="lblAddAdditionalVideos.Help" />
								</td>
								<td>
									<asp:GridView ID="gvAdditionalVideos"
										runat="server"
										AutoGenerateColumns="false"
										CssClass="listItemsTable"
										EnableModelValidation="True"
										GridLines="None"
										OnRowCommand="gvAdditionalVideos_RowCommand">
										<Columns>
											...
											<asp:TemplateField>
												<ItemTemplate>
													<div class="itemActions itemEditActions">
														<asp:LinkButton ID="lbRemoveAdditionalVideo" resourcekey="lbRemoveAdditionalVideo" CssClass="itemEditRemove" runat="server" CausesValidation="false" CommandArgument='<%# Eval("SystemFileName") %>' CommandName="Remove" OnClientClick="return AlertConfirm('video');" Text="Remove"></asp:LinkButton>
													</div>
												</ItemTemplate>
											</asp:TemplateField>
										</Columns>
						...
						<table class="additionalOptionsList fullWidthTable noTdBorders noTableBorder">
							<tr>
								<td class="subjectName textTop short">
									<dnn:Label ID="lblVideoDuration" runat="server" Text="Video duration:" HelpText="Video duration." ResourceKey="lblVideoDuration.Text" HelpKey="lblVideoDuration.HelpKey" />
								</td>
								<td>
									<div class="styledCheckbox noLabel">
										<asp:CheckBox ID="cbVideoDuration" runat="server" Checked="false" Text=" " />
									</div>
									<asp:Panel ID="divVideoDuration" runat="server" Style="display: none;">
										<asp:TextBox ID="tbVideoDuration" runat="server" CssClass="textCenter" ValidationGroup="vgEditVideo" Width="90px" />
										<asp:RequiredFieldValidator ID="rfvVideoDuration" runat="server" ControlToValidate="tbVideoDuration" CssClass="smallInfo error" Display="Dynamic" ErrorMessage="Required." ResourceKey="rfvValue.ErrorMessage" ValidationGroup="vgEditVideo" />
										<asp:CompareValidator ID="cvVideoDuration" runat="server" ControlToValidate="tbVideoDuration" ErrorMessage="Please enter number only." Operator="DataTypeCheck" Type="Integer" ValidationGroup="vgEditVideo" CssClass="smallInfo error" />
									</asp:Panel>
								</td>
							</tr>
						</table>
							...
							<tr>
								...
								<td>
									...
									<asp:Panel runat="server" ID="pnlEditEmbedStandardThumb" Visible="false" CssClass="paddingTop">
										<dnn:Label ID="Label18" runat="server" Text="Select standard thumbnail:" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/HTML/." ResourceKey="lblHTMLStandardThumbSelect.Text" HelpKey="lblHTMLStandardThumbSelect.HelpKey" ControlName="ddlEditHTMLThumbSelect"></dnn:Label>
										<div class="styledSelect">
							...
							<tr>
								...
								<td>
									...
									<asp:Panel runat="server" ID="pnlEditHTMLThumbSelect" Visible="false" CssClass="paddingTop">
										<dnn:Label ID="Label6" runat="server" Text="Select standard thumbnail:" HelpText="Select one of predefined thumbnails. Location - ControlPath/Thumbs/HTML/." ResourceKey="lblHTMLStandardThumbSelect.Text" HelpKey="lblHTMLStandardThumbSelect.HelpKey" ControlName="ddlEditHTMLThumbSelect"></dnn:Label>
										<div class="styledSelect">
