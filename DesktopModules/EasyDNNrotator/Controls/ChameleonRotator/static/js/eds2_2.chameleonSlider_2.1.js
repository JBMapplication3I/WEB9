		...
		return this.each(function () {
			var $t = $(this),
				...
				slider = {
					...
					main_panel: {
						init: function () {
							...
							if (option.redirect_on_click || option.lightbox_on_click) {
								$main_panel_media_link = $('<a href="#" class="media_link">Media link</a>');

								if (option.redirect_on_click)
									$main_panel_media_link.attr('target', option.redirect_on_click_target);

								$main_panel_media_link.attr('title', "Media link");
						...
						display: function (item_index) {
							...
							$main_panel_media_link.attr('title', item.linkTitle);
							$main_panel_media_link.text(item.linkTitle)
							if (item.type == 'image') {
					...
					autoplay_toggle: {
						init: function () {
							$autoplay_toggle = $('<a href="#" class="autoplay_toggle" title="Play/Pause">Play/Pause</a>');
					...
					arrows: {
						init: function () {
							$navigation_prev = $('<a href="#" class="navigation_button prev" title="Previous">Previous</a>');
							$navigation_next = $('<a href="#" class="navigation_button next" title="Next">Next</a>');
