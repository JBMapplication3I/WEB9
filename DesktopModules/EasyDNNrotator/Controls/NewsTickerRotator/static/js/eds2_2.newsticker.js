...
(function ($) {
    ...
    $.fn.newsticker.methods = {
        ...
        startup: function () {
            ...
            list.wrap('<div class="newsticker_wrapper newsticker_style_' + settings.style + ' ' + settings.themeClass + '" id="newsticker_' + this.api('getId') + '" style="position: relative; z-index: 150; overflow: hidden; "></div>');
