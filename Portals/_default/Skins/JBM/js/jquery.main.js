...
function initSlickCarousel() {
	jQuery('.cards-gallery').slick({
		...
		nextArrow: '<button class="slick-next"><i class="icon-arrow-left" style="transform: rotate(180deg);"></i></button>',
		responsive: [{
			breakpoint: 1025,
			settings: {
				slidesToScroll: 1,
	...
	jQuery('.product-gallery').each(function() {
		...
		var $sliderFor = $holder.find('.gallery-main');
		var $sliderNav = $holder.find('.gallery-nav');
