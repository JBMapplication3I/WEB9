...
<%@ Register TagPrefix="cef" TagName="CategoryMetaService" Src="~/DesktopModules/ClarityEcommerce/MetaService/CategoryMetaService.ascx" %>
<dnn:META ID="mobileScale" runat="server" Name="viewport" Content="width=device-width,initial-scale=1" />
<cef:CategoryMetaService id="cefCategoryMetaService" runat="server" />

<div class="siteWrapper">
  <dnn:HEADER ID="uxHeader" runat="server" SkinPath="<%# SkinPath %>" />
  <div id="body-with-min-height" class="w-100" style="min-height: 100vh;">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12" id="main" role="main" ui-view="main"></div>
      </div>
      <div class="row">
        <div class="col-12" cef-recently-viewed-products size="4"></div>
      </div>
      <div class="row">
        <div class="col-12" cef-personalization-products size="4"></div>
      </div>
      <div class="row">
