...
<div class="siteWrapper">
  ...
  <div id="body-with-min-height" class="w-100" style="min-height: 65vh;">
    ...
    <div class="container-xl main">
      ...
      <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto my-5">
          <h1 class="text-center mt-3"
            data-translate="ui.storefront.authentication.PleaseSignIn">
          </h1>
          <div cef-login return-url="/" after-login-action-mode="2"></div>
        </div>
      </div>
    </div>
    <div class="container-fluid">
