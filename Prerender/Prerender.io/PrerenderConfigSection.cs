namespace Prerender.io
{
    ...
    public sealed class PrerenderConfigSection : ConfigurationSection
    {
        ...
        {
            get { return (bool)this["stripApplicationNameFromRequestUrl"]; }
